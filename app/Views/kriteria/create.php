            ...
            <div class="card-body">
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="bobot" id="bobot" class="form-control <?= $validation->hasError('bobot') ? 'is-invalid': null; ?>" placeholder="Masukkan Bobot Kriteria" value="<?= old('bobot') ?? '0'; ?>">
                        <div class="invalid-feedback">
